...
public class Constant {
	...
	public static final String USERPICLOCALPATH="yourServerUserImgLocal";
	//服务器地址
	public static final String SERVICELOCALPAHT="yourServerLocal";
	//应用显示图标
	public static final String WEBICO="panda.ico";
	//发送用的邮箱
	public static final String SENDEMAIL="yourEmail";
	//发送用的邮箱授权码
	public static final String SENDPASSWORD="yourPoPCode";
	//发送的标题

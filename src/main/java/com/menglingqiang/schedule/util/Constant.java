...
public class Constant {
	...
	public static final String USERPICLOCALPATH="yourServerPicLocal";
	//服务器地址
	public static final String SERVICELOCALPAHT="";
	//应用显示图标
	public static final String WEBICO="panda.ico";
	//发送用的邮箱
	public static final String SENDEMAIL="youremail";
	//发送用的邮箱授权码
	public static final String SENDPASSWORD="yourEmailPopCode";
	//发送的标题
